...
import { UtcDateTimeService } from '@app/core/services/utc-datetime.service';
...
export abstract class AppComponentBase {
    ...
    utcDateTimeService: UtcDateTimeService;
    ...
    protected constructor(injector: Injector) {
        ...
        this.utcDateTimeService = injector.get(UtcDateTimeService);
