...
export class UserNotificationHelper extends AppComponentBase {
    ...
    getUrl(userNotification: abp.notifications.IUserNotification): string {
        switch (userNotification.notification.notificationName) {
            ...
            case 'App.ExpiryNotifications': {
                if (userNotification.notification.entityTypeName === 'Mohajer.ClassScheduleProject.Document.Contract.Contract') {
                    return '/app/contracts/-/create-or-update-contract/' + userNotification.notification.entityId;
                }
            }
    ...
    show(userNotification: abp.notifications.IUserNotification): void {
        ...
        if (Push.default.Permission.has()) {
            ...
            Push.default.create('ClassScheduleProject', {
