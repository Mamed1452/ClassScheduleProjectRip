...
import { ClassScheduleProjectCommonModule } from '@shared/common/common.module';
...
import { WidgetJalaliModule } from '@app/core/modules/widget-jalali/widget-jalali.module';
...
@NgModule({
  imports: [
    ...
    ModalModule.forRoot(),
    UtilsModule,
    ClassScheduleProjectCommonModule,
    TableModule,
    PaginatorModule,
    GridsterModule,
    TabsModule.forRoot(),
