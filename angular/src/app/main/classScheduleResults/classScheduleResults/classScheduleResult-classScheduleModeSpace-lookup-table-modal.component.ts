...
@Component({
    selector: 'classScheduleResultClassScheduleModeSpaceLookupTableModal',
    styleUrls: ['./classScheduleResult-classScheduleModeSpace-lookup-table-modal.component.less'],
    encapsulation: ViewEncapsulation.None,
    templateUrl: './classScheduleResult-classScheduleModeSpace-lookup-table-modal.component.html',
})
export class ClassScheduleResultClassScheduleModeSpaceLookupTableModalComponent extends AppComponentBase {
