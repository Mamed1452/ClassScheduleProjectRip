...
import { MasterDetailChild_ListOfAllCalculatedResult_CreateOrEditClassScheduleResultModalComponent } from './masterDetailChild_ListOfAllCalculatedResult_create-or-edit-classScheduleResult-modal.component';

import { MasterDetailChild_ListOfAllCalculatedResult_ViewClassScheduleResultModalComponent } from './masterDetailChild_ListOfAllCalculatedResult_view-classScheduleResult-modal.component';
...
@Component({
    templateUrl: './masterDetailChild_ListOfAllCalculatedResult_classScheduleResults.component.html',
    selector: 'masterDetailChild_ListOfAllCalculatedResult_classScheduleResults-component',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class MasterDetailChild_ListOfAllCalculatedResult_ClassScheduleResultsComponent extends AppComponentBase {
    @Input('listOfAllCalculatedResultId') listOfAllCalculatedResultId: any;

    @ViewChild('entityTypeHistoryModal', { static: true }) entityTypeHistoryModal: EntityTypeHistoryModalComponent;
    @ViewChild('createOrEditClassScheduleResultModal', { static: true })
    createOrEditClassScheduleResultModal: MasterDetailChild_ListOfAllCalculatedResult_CreateOrEditClassScheduleResultModalComponent;
    @ViewChild('viewClassScheduleResultModalComponent', { static: true })
    viewClassScheduleResultModal: MasterDetailChild_ListOfAllCalculatedResult_ViewClassScheduleResultModalComponent;
    ...
    createClassScheduleResult(): void {
        this.createOrEditClassScheduleResultModal.show(this.listOfAllCalculatedResultId);
    }
