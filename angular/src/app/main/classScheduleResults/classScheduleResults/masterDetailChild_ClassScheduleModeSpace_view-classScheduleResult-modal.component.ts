...
@Component({
    selector: 'masterDetailChild_ClassScheduleModeSpace_viewClassScheduleResultModal',
    templateUrl: './masterDetailChild_ClassScheduleModeSpace_view-classScheduleResult-modal.component.html',
})
export class MasterDetailChild_ClassScheduleModeSpace_ViewClassScheduleResultModalComponent extends AppComponentBase {
