...
import { CreateOrEditClassScheduleResultModalComponent } from './create-or-edit-classScheduleResult-modal.component';

import { ViewClassScheduleResultModalComponent } from './view-classScheduleResult-modal.component';
...
@Component({
    templateUrl: './classScheduleResults.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class ClassScheduleResultsComponent extends AppComponentBase {
    @ViewChild('entityTypeHistoryModal', { static: true }) entityTypeHistoryModal: EntityTypeHistoryModalComponent;
    @ViewChild('createOrEditClassScheduleResultModal', { static: true })
    createOrEditClassScheduleResultModal: CreateOrEditClassScheduleResultModalComponent;
    @ViewChild('viewClassScheduleResultModalComponent', { static: true })
    viewClassScheduleResultModal: ViewClassScheduleResultModalComponent;
    ...
    createClassScheduleResult(): void {
        this.createOrEditClassScheduleResultModal.show();
    }
