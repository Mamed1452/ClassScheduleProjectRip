...
@Component({
    templateUrl: './universityProfessorWorkingTimes.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class UniversityProfessorWorkingTimesComponent extends AppComponentBase {
    ...
    _entityTypeFullName =
        'Mohajer.ClassScheduleProject.CentralUnit.UniversityProfessorWorkingTimes.UniversityProfessorWorkingTime';
    ...
    getUniversityProfessorWorkingTimes(event?: LazyLoadEvent) {
    ...
    deleteUniversityProfessorWorkingTime(universityProfessorWorkingTime: UniversityProfessorWorkingTimeDto): void {
        this.message.confirm('', this.l('AreYouSure'), (isConfirmed) => {
            if (isConfirmed) {
                this._universityProfessorWorkingTimesServiceProxy
                    .delete(universityProfessorWorkingTime.id)
                    .subscribe(() => {
                        this.reloadPage();
    ...
    exportToExcel(): void {
        this._universityProfessorWorkingTimesServiceProxy
            .getUniversityProfessorWorkingTimesToExcel(
                this.filterText,
                this.universityProfessorUniversityProfessorNameFilter,
                this.workTimeInDayNameWorkTimeInDayFilter
            )
