...
@Component({
    templateUrl: './masterDetailChild_UniversityDepartment_universityMajors.component.html',
    selector: 'masterDetailChild_UniversityDepartment_universityMajors-component',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()],
})
export class MasterDetailChild_UniversityDepartment_UniversityMajorsComponent extends AppComponentBase {
    @Input('universityDepartmentId') universityDepartmentId: any;

    @ViewChild('entityTypeHistoryModal', { static: true }) entityTypeHistoryModal: EntityTypeHistoryModalComponent;
    @ViewChild('createOrEditUniversityMajorModal', { static: true })
    createOrEditUniversityMajorModal: MasterDetailChild_UniversityDepartment_CreateOrEditUniversityMajorModalComponent;
    @ViewChild('viewUniversityMajorModalComponent', { static: true })
    viewUniversityMajorModal: MasterDetailChild_UniversityDepartment_ViewUniversityMajorModalComponent;
    ...
    createUniversityMajor(): void {
        this.createOrEditUniversityMajorModal.show(this.universityDepartmentId);
    }
