...
import {
    GetClassScheduleModeSpaceForViewDto,
    ClassScheduleModeSpaceDto,
} from '@shared/service-proxies/service-proxies';
import { AppComponentBase } from '@shared/common/app-component-base';

@Component({
    selector: 'viewClassScheduleModeSpaceModal',
    templateUrl: './view-classScheduleModeSpace-modal.component.html',
})
export class ViewClassScheduleModeSpaceModalComponent extends AppComponentBase {
