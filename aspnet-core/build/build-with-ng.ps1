...
$webHostFolder = Join-Path $slnFolder "src/Mohajer.ClassScheduleProject.Web.Host"
$webPublicFolder = Join-Path $slnFolder "src/Mohajer.ClassScheduleProject.Web.Public"
