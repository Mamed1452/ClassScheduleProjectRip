...
using Mohajer.ClassScheduleProject.Web.Authentication.JwtBearer;
using Mohajer.ClassScheduleProject.Web.Authentication.TwoFactor;
using Mohajer.ClassScheduleProject.Web.Chat.SignalR;
using Mohajer.ClassScheduleProject.Web.Configuration;
using Mohajer.ClassScheduleProject.Web.DashboardCustomization;

namespace Mohajer.ClassScheduleProject.Web
{
    [DependsOn(
        typeof(ClassScheduleProjectApplicationModule),
        typeof(ClassScheduleProjectEntityFrameworkCoreModule),
    ...
    public class ClassScheduleProjectWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ClassScheduleProjectWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(ClassScheduleProjectApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ClassScheduleProjectWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ClassScheduleProjectWebCoreModule).Assembly);
        }
