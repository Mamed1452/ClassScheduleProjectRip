...
namespace Mohajer.ClassScheduleProject.Web.Security.Recaptcha
{
    public class RecaptchaValidator : ClassScheduleProjectServiceBase, IRecaptchaValidator, ITransientDependency
    {
