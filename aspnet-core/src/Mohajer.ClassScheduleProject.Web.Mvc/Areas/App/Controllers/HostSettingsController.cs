...
using Mohajer.ClassScheduleProject.Configuration.Host;
using Mohajer.ClassScheduleProject.Editions;
using Mohajer.ClassScheduleProject.Timing;
using Mohajer.ClassScheduleProject.Timing.Dto;
using Mohajer.ClassScheduleProject.Web.Areas.App.Models.HostSettings;
...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Controllers
{
    ...
    public class HostSettingsController : ClassScheduleProjectControllerBase
    {
