...
using Mohajer.ClassScheduleProject.Configuration.Tenants;
...
using Mohajer.ClassScheduleProject.Web.Areas.App.Models.Settings;
...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Controllers
{
    ...
    public class SettingsController : ClassScheduleProjectControllerBase
    {
