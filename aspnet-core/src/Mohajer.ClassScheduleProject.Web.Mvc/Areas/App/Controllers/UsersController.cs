...
using Mohajer.ClassScheduleProject.Web.Areas.App.Models.Roles;
using Mohajer.ClassScheduleProject.Web.Areas.App.Models.Users;
...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Controllers
{
    ...
    public class UsersController : ClassScheduleProjectControllerBase
    {
