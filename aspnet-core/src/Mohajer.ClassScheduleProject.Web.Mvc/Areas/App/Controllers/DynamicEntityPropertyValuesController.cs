...
using Mohajer.ClassScheduleProject.Web.Areas.App.Models.DynamicEntityPropertyValues;
...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : ClassScheduleProjectControllerBase
    {
