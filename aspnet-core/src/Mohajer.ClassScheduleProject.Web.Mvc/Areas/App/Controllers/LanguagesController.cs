...
using Mohajer.ClassScheduleProject.Web.Areas.App.Models.Languages;
...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : ClassScheduleProjectControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = ClassScheduleProjectConsts.LocalizationSourceName;
            }
