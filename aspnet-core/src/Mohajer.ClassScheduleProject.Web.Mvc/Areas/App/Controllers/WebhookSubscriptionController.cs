...
using Mohajer.ClassScheduleProject.Web.Areas.App.Models.Webhooks;
using Mohajer.ClassScheduleProject.Web.Controllers;
using Mohajer.ClassScheduleProject.WebHooks;
...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Controllers
{
    ...
    public class WebhookSubscriptionController : ClassScheduleProjectControllerBase
    {
