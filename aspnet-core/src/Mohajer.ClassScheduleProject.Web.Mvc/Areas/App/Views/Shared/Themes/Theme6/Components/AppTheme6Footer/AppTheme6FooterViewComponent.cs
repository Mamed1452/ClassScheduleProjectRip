...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Views.Shared.Themes.Theme6.Components.AppTheme6Footer
{
    public class AppTheme6FooterViewComponent : ClassScheduleProjectViewComponent
    {
