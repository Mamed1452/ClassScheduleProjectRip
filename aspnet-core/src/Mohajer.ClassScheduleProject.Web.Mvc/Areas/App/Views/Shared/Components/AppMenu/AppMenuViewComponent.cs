...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Views.Shared.Components.AppMenu
{
    public class AppMenuViewComponent : ClassScheduleProjectViewComponent
    {
