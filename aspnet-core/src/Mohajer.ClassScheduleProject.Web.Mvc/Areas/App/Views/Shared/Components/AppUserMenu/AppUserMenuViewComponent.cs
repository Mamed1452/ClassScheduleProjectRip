...
namespace Mohajer.ClassScheduleProject.Web.Areas.App.Views.Shared.Components.AppUserMenu
{
    public class AppUserMenuViewComponent : ClassScheduleProjectViewComponent
    {
