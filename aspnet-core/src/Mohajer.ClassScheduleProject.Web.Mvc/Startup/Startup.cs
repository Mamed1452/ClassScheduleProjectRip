...
using Mohajer.ClassScheduleProject.Identity;
using Mohajer.ClassScheduleProject.Schemas;
using Mohajer.ClassScheduleProject.Web.Chat.SignalR;
using Mohajer.ClassScheduleProject.Web.Common;
using Mohajer.ClassScheduleProject.Web.Resources;
using Swashbuckle.AspNetCore.Swagger;
using Mohajer.ClassScheduleProject.Web.IdentityServer;
using Mohajer.ClassScheduleProject.Web.Swagger;
using Stripe;
...
using Mohajer.ClassScheduleProject.Web.HealthCheck;
using Owl.reCAPTCHA;
using HealthChecksUISettings = HealthChecks.UI.Configuration.Settings;
using Microsoft.AspNetCore.Server.Kestrel.Https;

namespace Mohajer.ClassScheduleProject.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerDoc("v1", new OpenApiInfo() {Title = "ClassScheduleProject API", Version = "v1"});
            ...
            return services.AddAbp<ClassScheduleProjectWebMvcModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                {
                    options.SwaggerEndpoint(_appConfiguration["App:SwaggerEndPoint"], "ClassScheduleProject API V1");
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("Mohajer.ClassScheduleProject.Web.wwwroot.swagger.ui.index.html");
