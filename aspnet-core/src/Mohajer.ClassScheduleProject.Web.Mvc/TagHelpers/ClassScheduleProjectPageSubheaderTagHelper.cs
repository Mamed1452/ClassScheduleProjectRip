...
using Mohajer.ClassScheduleProject.UiCustomization.Dto;

namespace Mohajer.ClassScheduleProject.Web.TagHelpers
{
    ...
    public class ClassScheduleProjectPageSubheaderTagHelper : TagHelper
    {
        ...
        public ClassScheduleProjectPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
