...
using Mohajer.ClassScheduleProject.UiCustomization;
...
{
    public class SessionAppService : ClassScheduleProjectAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = ClassScheduleProjectConsts.Currency,
                    CurrencySign = ClassScheduleProjectConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = ClassScheduleProjectConsts.AllowTenantsToChangeEmailSettings,
