...
using Mohajer.ClassScheduleProject.DemoUiComponents.Dto;

namespace Mohajer.ClassScheduleProject.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : ClassScheduleProjectAppServiceBase, IDemoUiComponentsAppService
    {
