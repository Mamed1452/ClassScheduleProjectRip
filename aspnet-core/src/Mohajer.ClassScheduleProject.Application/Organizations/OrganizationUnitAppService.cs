...
namespace Mohajer.ClassScheduleProject.Organizations
{
    [AbpAuthorize(AppPermissions.Pages_Administration_OrganizationUnits)]
    public class OrganizationUnitAppService : ClassScheduleProjectAppServiceBase, IOrganizationUnitAppService
    {
