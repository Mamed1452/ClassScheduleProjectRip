...
namespace Mohajer.ClassScheduleProject.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ClassScheduleProjectAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ClassScheduleProjectDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ClassScheduleProjectConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ClassScheduleProjectConsts.ConnectionStringName}", constring);
        }
