...
using Mohajer.ClassScheduleProject.Auditing.Exporting;
...
using EntityHistoryHelper = Mohajer.ClassScheduleProject.EntityHistory.EntityHistoryHelper;

namespace Mohajer.ClassScheduleProject.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ClassScheduleProjectAppServiceBase, IAuditLogAppService
    {
