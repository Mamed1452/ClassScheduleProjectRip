...
namespace Mohajer.ClassScheduleProject.DataExporting.Excel.NPOI
{
    public abstract class NpoiExcelExporterBase : ClassScheduleProjectServiceBase, ITransientDependency
    {
