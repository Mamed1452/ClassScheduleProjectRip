...
namespace Mohajer.ClassScheduleProject.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : ClassScheduleProjectServiceBase, ITransientDependency
    {
