...
using Mohajer.ClassScheduleProject.Authorization.Users.Profile.Cache;
...
using Mohajer.ClassScheduleProject.Gdpr;
...
using Mohajer.ClassScheduleProject.Timing;

namespace Mohajer.ClassScheduleProject.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ClassScheduleProjectAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Mohajer.ClassScheduleProject",
