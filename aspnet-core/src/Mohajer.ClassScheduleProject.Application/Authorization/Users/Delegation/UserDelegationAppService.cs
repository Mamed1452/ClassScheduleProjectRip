...
namespace Mohajer.ClassScheduleProject.Authorization.Users.Delegation
{
    [AbpAuthorize]
    public class UserDelegationAppService : ClassScheduleProjectAppServiceBase, IUserDelegationAppService
    {
