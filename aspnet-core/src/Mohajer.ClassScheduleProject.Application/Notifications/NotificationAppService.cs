...
{
    [AbpAuthorize]
    public class NotificationAppService : ClassScheduleProjectAppServiceBase, INotificationAppService
    {
        ...
        public async Task SubscribeExpiryNotifications()
        {
            await _notificationSubscriptionManager.SubscribeAsync(AbpSession.ToUserIdentifier(), AppNotificationNames.ExpiryNotifications);
        }
    }
}