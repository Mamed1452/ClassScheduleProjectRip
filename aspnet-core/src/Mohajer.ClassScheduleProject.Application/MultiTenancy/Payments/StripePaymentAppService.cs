...
using Mohajer.ClassScheduleProject.MultiTenancy.Payments.Stripe;
...
{
    public class StripePaymentAppService : ClassScheduleProjectAppServiceBase, IStripePaymentAppService
    {
