...
using Mohajer.ClassScheduleProject.EntityFrameworkCore.Repositories;

namespace Mohajer.ClassScheduleProject.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : ClassScheduleProjectRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ClassScheduleProjectDbContext> dbContextProvider)
