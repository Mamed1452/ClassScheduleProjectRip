...
{
    public class SubscriptionPaymentExtensionDataRepository : ClassScheduleProjectRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<ClassScheduleProjectDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
