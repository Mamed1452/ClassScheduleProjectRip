...
using Mohajer.ClassScheduleProject.Web.Startup.ExternalLoginInfoProviders;
...
namespace Mohajer.ClassScheduleProject.Web.Startup
{
    ...
    public class ClassScheduleProjectWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ClassScheduleProjectWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ClassScheduleProjectWebHostModule).GetAssembly());
        }
