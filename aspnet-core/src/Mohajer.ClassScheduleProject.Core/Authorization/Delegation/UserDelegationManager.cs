...
namespace Mohajer.ClassScheduleProject.Authorization.Delegation
{
    public class UserDelegationManager : ClassScheduleProjectServiceBase, IUserDelegationManager
    {
