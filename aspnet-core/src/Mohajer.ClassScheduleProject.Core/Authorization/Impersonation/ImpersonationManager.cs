...
namespace Mohajer.ClassScheduleProject.Authorization.Impersonation
{
    public class ImpersonationManager : ClassScheduleProjectDomainServiceBase, IImpersonationManager
    {
