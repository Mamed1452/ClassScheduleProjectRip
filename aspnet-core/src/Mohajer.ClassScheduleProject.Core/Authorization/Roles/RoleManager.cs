...
namespace Mohajer.ClassScheduleProject.Authorization.Roles
{
    /// <summary>
    /// Role manager.
    ...
    public class RoleManager : AbpRoleManager<Role, User>
    {
        ...
        {
            return _localizationManager.GetString(ClassScheduleProjectConsts.LocalizationSourceName, name);
        }
    }
}
