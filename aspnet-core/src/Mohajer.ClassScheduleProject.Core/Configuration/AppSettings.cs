namespace Mohajer.ClassScheduleProject.Configuration
{
    ...
    public static class AppSettings
    {
        ...
        public static class TenantManagement
        {
            ...
            public const string CrmValueAddedPercentage = "App.TenantManagement.CrmValueAddedPercentage";
            public const string CrmStartLetterNumber = "App.TenantManagement.CrmStartLetterNumber";
