...
namespace Mohajer.ClassScheduleProject.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ClassScheduleProjectServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Mohajer.ClassScheduleProject", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
