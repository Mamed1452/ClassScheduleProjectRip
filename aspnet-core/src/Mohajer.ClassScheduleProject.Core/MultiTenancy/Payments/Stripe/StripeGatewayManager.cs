...
{
    public class StripeGatewayManager : ClassScheduleProjectServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "ClassScheduleProject";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + ClassScheduleProjectConsts.Currency;
        }
