...
using Mohajer.ClassScheduleProject.MultiTenancy.Demo;
...
namespace Mohajer.ClassScheduleProject.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
            ...
            string emailActivationLink)
        {
            ...
            {
                throw new UserFriendlyException(LocalizationManager.GetString(ClassScheduleProjectConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(ClassScheduleProjectConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
