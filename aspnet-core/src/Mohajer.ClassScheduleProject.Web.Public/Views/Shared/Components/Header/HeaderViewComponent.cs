...
using Mohajer.ClassScheduleProject.Web.Public.Startup;
using Mohajer.ClassScheduleProject.Web.Session;

namespace Mohajer.ClassScheduleProject.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ClassScheduleProjectViewComponent
    {
