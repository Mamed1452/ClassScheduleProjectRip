...
namespace Mohajer.ClassScheduleProject.Web.Public.Startup
{
    [DependsOn(
        typeof(ClassScheduleProjectWebCoreModule)
    )]
    public class ClassScheduleProjectWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public ClassScheduleProjectWebFrontEndModule(IWebHostEnvironment env, ClassScheduleProjectEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ClassScheduleProjectWebFrontEndModule).GetAssembly());
        }
    }
}
