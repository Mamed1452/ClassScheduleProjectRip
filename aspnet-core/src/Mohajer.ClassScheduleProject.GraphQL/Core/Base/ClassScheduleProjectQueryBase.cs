...
namespace Mohajer.ClassScheduleProject.Core.Base
{
    public abstract class ClassScheduleProjectQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ClassScheduleProjectQueryBase(string fieldName,
