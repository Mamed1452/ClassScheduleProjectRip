...
using Mohajer.ClassScheduleProject.Commands;
using Mohajer.ClassScheduleProject.Core.Threading;
using Mohajer.ClassScheduleProject.Models.NavigationMenu;
using Mohajer.ClassScheduleProject.Services.Navigation;
...
using Mohajer.ClassScheduleProject.ApiClient;
using Mohajer.ClassScheduleProject.Controls;
using Mohajer.ClassScheduleProject.Dto;
using Mohajer.ClassScheduleProject.Extensions;
using Mohajer.ClassScheduleProject.Localization;
using Mohajer.ClassScheduleProject.UI;
using Mohajer.ClassScheduleProject.UI.Assets;
using Mohajer.ClassScheduleProject.Views;
using DependencyResolver = Mohajer.ClassScheduleProject.Core.Dependency.DependencyResolver;
...
namespace Mohajer.ClassScheduleProject.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "ClassScheduleProject";
