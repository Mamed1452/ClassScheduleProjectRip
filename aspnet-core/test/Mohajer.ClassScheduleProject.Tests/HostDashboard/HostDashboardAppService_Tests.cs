...
using Mohajer.ClassScheduleProject.MultiTenancy.HostDashboard;
...
namespace Mohajer.ClassScheduleProject.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ClassScheduleProjectDbContext context, SubscriptionPayment subscriptionPayment)
        {
